...
class obj_banniere_actu extends obj_editable {
	...
	public function afficher($mode, $langue) {
		...
		if (strcmp($mode, _PETILABO_MODE_EDIT)) {
			...
			list($trad_titre, $src_titre) = $this->check_src_texte($this->obj_texte, $id_titre, $langue);
			$this->ouvrir_ligne();
			...
			$this->fermer_ligne($src_titre);
			$id_sous_titre = $this->obj_texte->get_id_sous_titre_actu($this->no_actu);
			list($trad_sous_titre, $src_sous_titre) = $this->check_src_texte($this->obj_texte, $id_sous_titre, $langue);
			$this->ouvrir_ligne();
			...
			$this->fermer_ligne($src_sous_titre);
			$id_resume = $this->obj_texte->get_id_resume_actu($this->no_actu);
			list($trad_resume, $src_resume) = $this->check_src_texte($this->obj_texte, $id_resume, $langue);
			$this->ouvrir_ligne();
			...
			$this->fermer_ligne($src_resume);
			$id_texte = $this->obj_texte->get_id_texte_actu($this->no_actu);
			list($trad_texte, $src_texte) = $this->check_src_texte($this->obj_texte, $id_texte, $langue);
			$this->ouvrir_ligne();
